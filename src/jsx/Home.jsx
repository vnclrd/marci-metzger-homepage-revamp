  ...
  return (
    <>
      <div id='home' className='w-full h-screen flex flex-col'>
        <div className='absolute w-[800px] h-[300px] top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-2 
                bg-[#303030] z-950 flex rounded-xl overflow-hidden'>
          <div className='w-[450px] h-[300px] bg-amber-50 flex flex-col items-center pt-10 shadow'>
            <h1 className='text-[#1e1e1e] text-[1.5rem] font-poppins leading-7 tracking-wide font-bold'>
